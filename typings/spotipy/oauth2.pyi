...
class SpotifyOAuth(SpotifyAuthBase):
    ...
    def validate_token(self, token_info): # -> Any | None:
        ...
    ...
    @staticmethod
    def parse_auth_response_url(url): # -> tuple[Any | None, ...]:
        ...
    ...
    def get_access_token(self, code=..., as_dict=..., check_cache=...): # -> Any:
...
class SpotifyPKCE(SpotifyAuthBase):
    ...
    def get_access_token(self, code=..., check_cache=...): # -> Any:
...
class SpotifyImplicitGrant(SpotifyAuthBase):
    ...
    * parse_response_token(url) ->
    ...
    def get_access_token(self, state=..., response=..., check_cache=...): # -> None:
    ...
    def parse_response_token(self, url, state=...): # -> dict[str, Any | None]:
        """ Parse the response code in the given response url """
        ...
    ...
    def get_auth_response(self, state=...): # -> dict[str, Any | None]:
