...
class Spotify:
    ...
    def artist_albums(self, artist_id, album_type=..., include_groups=..., country=..., limit=..., offset=...): # -> Any | None:
    ...
    def album(self, album_id, market=...): # -> Any | None:
    ...
    def albums(self, albums, market=...): # -> Any | None:
    ...
    def search_markets(self, q, limit=..., offset=..., type=..., markets=..., total=...): # -> defaultdict[Any, dict[Any, Any]]:
    ...
    def user_playlist_add_episodes(self, user, playlist_id, episodes, position=...): # -> Any | None:
        """ This function is no longer in use, please use the recommended function in the warning!
    ...
    def current_user_follow_playlist(self, playlist_id, public=...): # -> Any | None:
        """
        Add the current authenticated user as a follower of a playlist.
    ...
    def recommendations(self, seed_artists=..., seed_genres=..., seed_tracks=..., limit=..., country=..., **kwargs): # -> Any | None:
    ...
    def start_playback(self, device_id=..., context_uri=..., uris=..., offset=..., position_ms=...): # -> Any | None:
    ...
    def get_audiobook(self, id, market=...): # -> Any | None:
    ...
    def get_audiobooks(self, ids, market=...): # -> Any | None:
    ...
    def get_audiobook_chapters(self, id, market=..., limit=..., offset=...): # -> Any | None:
